...
class Query extends Component {
    ...
    newSmoothies = [
        ...
        {name: 'Ice', desc: "If you have problems with heartburn - Smoothie Delight Ice will take care of you and apply pleasant cooling effect in your throat (great for hot days!)", iconUni:'❄️'},
    ...
    render() {
        ...
        if(this.state.voted){
            return(
                <section className='query page' style={{height: '60vh', display: 'flex', justifyContent: 'center'}}>
                    <h2 className='page__header' style={{alignSelf:'center'}}>Thank you for your vote!</h2>
                </section>
            )
        }
        return (
            <section className='query page'>
                <h1 className='page__header'>Be a part of Food Factor and decide</h1>
                <p className='page__text'>Our company tries to keep up with customer's desires and that is why we kindly ask you for favor - take a minute of your time and decide which line of Smoothie Delight should we develop now:</p>
